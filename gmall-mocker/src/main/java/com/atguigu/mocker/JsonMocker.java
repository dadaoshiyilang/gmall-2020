...
import com.atguigu.RanOpt;
import com.atguigu.RandomDate;
import com.atguigu.RandomNum;
import com.atguigu.RandomOptionGroup;
...
public class JsonMocker {
    ...
    private RanOpt[] eventOpts = {new RanOpt("addFavor", 10),
            new RanOpt("addComment", 30),new RanOpt("addCart", 20),
            new RanOpt("clickItem", 4), new RanOpt("coupon", 45)};
